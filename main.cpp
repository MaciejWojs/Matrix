...
int main() {
    ...
    std::cout << "Matrix 2 (copy of Matrix 1):\n";
    m2.print();
    ...
    std::cout << "\nMatrix after filling above diagonal:\n";
    s.fill_above_diagonal();
    s.print();

    std::cout << "\nMatrix after filling under diagonal:\n";
    s.clear();
    s.fill_under_diagonal();
    s.print();

    std::cout << "\nMatrix after setting checker shape:\n";
    s.clear();
    s.check_shape();
    s.print();
    return 0;
